...
public class ProfileFragment extends Fragment {
    ...
    private TextView tvmyprofilelogo,tvcontactuslogo, tvchangepassword,btnlogout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvcontactuslogo = (TextView) view.findViewById(R.id.tv_contact_us_logo_user);
//        tvrestaurantdetail = (TextView) view.findViewById(R.id.tv_restaurant_detail_user);
        ...
        tvcontactuslogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
